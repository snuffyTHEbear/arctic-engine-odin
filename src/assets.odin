...
init_atlas ::proc() -> Atlas {
    ...
    rl.ImageDrawRectangle(&img, s(0, SCALE_FACTOR), s(0,SCALE_FACTOR), 
                                s(64, SCALE_FACTOR), s(64, SCALE_FACTOR), 
                                rl.WHITE)
    ...
    // rl.ImageDrawRectangleLines(&img, rect2, s(1, SCALE_FACTOR), rl.ORANGE)
